...
#'    \item `CRAN_cranly_data` - [`data.frame`] with class [`cranly_db`] that is created using [`cranly::clean_CRAN_db()`]. The function [`cranly::clean_CRAN_db()`] cleans the [`data.frame`] generated by [tools::CRAN_package_db()], has the same variables as `CRAN_data`.
...
#'    \item `TEST` - returns the `TEST` value used in the function. As this function is used within the `get_nlp` function,
#'                   and information about whether a subset of the full data is being used needs to be carried forward.
#'  }
#'
#' @examples
#' \dontrun{
