...
#' * Next we use code, provided by Dirk Eddilbettel, which extracts the titles and descriptions of each of the packages on CRAN.
#'   This is given in a matrix object with a row for each package.
