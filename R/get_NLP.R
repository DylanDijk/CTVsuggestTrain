...
get_NLP = function(TEST = FALSE){
  ...
  input_CRAN_data = CTVsuggest:::get_data(TEST = TEST)
...
return(list("feature_matrix_titles_descriptions_packages_cosine" = feature_matrix_titles_descriptions_packages_cosine, "input_CRAN_data" = input_CRAN_data))
