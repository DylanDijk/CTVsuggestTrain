...
Currently, I have a script that executes the model building with the most up to date data. The script trains the model, and then I push the predicted classification probabilities for each package to a gitHub repo. 

I now describe how the model is constructed.
...
I have extracted the Task View text data from their corresponding markdown files that exist within their GitHub repositories. All of the GitHub repositories can be found in the  [cran-task-views](https://github.com/cran-task-views) GitHub account.
